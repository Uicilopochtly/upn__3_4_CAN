...
begin
  ...
  _UPN1_3_:
      AssignFile(s_rmd.customization_opu.myFile, '.\rmd\save\customization_opu_3_rmd.txt');
  _UPN1_4_:
      AssignFile(s_rmd.customization_opu.myFile, '.\rmd\save\customization_opu_4_rmd.txt');
   _UPN1_41_:
      AssignFile(s_rmd.customization_opu.myFile, '.\rmd\save\customization_opu_41_rmd.txt');

  _UPN1_BUF_:
      AssignFile(s_rmd.customization_opu.myFile, '.\rmd\save\customization_opu_B_rmd.txt');
  end;
  //----------------------------------------------------------------------------
